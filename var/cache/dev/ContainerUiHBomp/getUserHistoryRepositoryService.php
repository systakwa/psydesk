 ...
 */
class getUserHistoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserHistoryRepository' shared autowired service.
     *
     * @return \App\Repository\UserHistoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserHistoryRepository.php';

        return $container->privates['App\\Repository\\UserHistoryRepository'] = new \App\Repository\UserHistoryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

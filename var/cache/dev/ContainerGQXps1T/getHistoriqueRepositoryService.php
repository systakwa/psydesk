...
class getHistoriqueRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HistoriqueRepository.php';

        return $container->privates['App\\Repository\\HistoriqueRepository'] = new \App\Repository\HistoriqueRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

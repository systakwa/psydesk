...
/* notejour/index_psy.html.twig */
class __TwigTemplate_6e1206477dd19e9c0faebb9b74ba19b4 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "notejour/index_psy.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "notejour/index_psy.html.twig"));
...
<html lang=\"en\">
    ...
    <body class=\"d-flex flex-column h-100 bg-light\">
        ...
        // line 29
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_note_psy");
        yield "\">Mes objectifs aaaaa</a></li>
                            <li class=\"nav-item\"><a class=\"nav-link\" href=\"";
        // line 30
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["note"]) {
                ...
                yield "\">
                                                ...
                                                <div class=\"p-3 text-center\">
                                                    ";
                // line 68
                if ((CoreExtension::getAttribute($this->env, $this->source, $context["note"], "idObjectif", [], "any", true, true, false, 68) && CoreExtension::getAttribute($this->env, $this->source, $context["note"], "idObjectif", [], "any", false, false, false, 68))) {
                    // line 69
                    yield "                                                        <div class=\"small text-muted mb-2\">QR de l'objectif</div>
                                                        <img src=\"";
                    // line 70
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(("https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=" . Twig\Extension\CoreExtension::urlencode($this->extensions['Symfony\Bridge\Twig\Extension\HttpFoundationExtension']->generateAbsoluteUrl($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("api_objectif_notes", ["id" => CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["note"], "idObjectif", [], "any", false, false, false, 70), "id", [], "any", false, false, false, 70)])))), "html", null, true);
    ...
    {
        return "notejour/index_psy.html.twig";
    }
    ...
    {
        return array (  226 => 114,  198 => 89,  186 => 79,  183 => 78,  172 => 72,  167 => 70,  164 => 69,  162 => 68,  153 => 62,  149 => 61,  144 => 59,  139 => 57,  135 => 56,  131 => 55,  127 => 54,  120 => 53,  113 => 48,  108 => 47,  104 => 45,  102 => 44,  85 => 30,  81 => 29,  74 => 25,  48 => 1,);
    }
...
<html lang=\"en\">
    ...
    <body class=\"d-flex flex-column h-100 bg-light\">
        <main class=\"flex-shrink-0\">
            ...
            <nav class=\"navbar navbar-expand-lg navbar-light bg-white py-3\">
                <div class=\"container px-5\">
                    <a class=\"navbar-brand\" href=\"{{ path('app_psychologue_dashboard') }}\"><span class=\"fw-bolder text-primary\">Mon Suivi</span></a>
                    <button class=\"navbar-toggler\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#navbarSupportedContent\" aria-controls=\"navbarSupportedContent\" aria-expanded=\"false\" aria-label=\"Toggle navigation\"><span class=\"navbar-toggler-icon\"></span></button>
                    <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">
                        <ul class=\"navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder\">
                            <li class=\"nav-item\"><a class=\"nav-link\" href=\"{{ path('app_note_psy') }}\">Mes objectifs aaaaa</a></li>
                                    ...
                                    <div class=\"card overflow-hidden shadow rounded-4 border-0 mb-5\">
                                        <div class=\"card-body p-0\">
                                            <div class=\"d-flex align-items-center\">
                                                ...
                                                <div class=\"p-3 text-center\">
                                                    {% if note.idObjectif is defined and note.idObjectif %}
                                                        <div class=\"small text-muted mb-2\">QR de l'objectif</div>
                                                        <img src=\"{{ 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=' ~ (absolute_url(path('api_objectif_notes', {'id': note.idObjectif.id}))|url_encode) }}\" alt=\"QR code\" style=\"width:140px;height:140px;border:1px solid #eee;border-radius:6px;\" />
                                                    {% endif %}
                                                </div>
...
</html>", "notejour/index_psy.html.twig", "D:\\3A22\\web projet\\psydesk-users-management\\templates\\notejour\\index_psy.html.twig");
    }
}

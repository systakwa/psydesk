 ...
 */
class getNotejourRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NotejourRepository' shared autowired service.
     *
     * @return \App\Repository\NotejourRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NotejourRepository.php';

        return $container->privates['App\\Repository\\NotejourRepository'] = new \App\Repository\NotejourRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
